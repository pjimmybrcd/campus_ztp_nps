...
def ruckus_controller_start_session(device, username, password, enable_username, enable_password, via):
    session = None
    if via == 'ssh':
        session = Ruckus_Controller_Session.Ruckus_Controller_Session(device, username, password,
                                            enable_username, enable_password)
    return session
